...
<?php }else{ ?>
  <a class="nav-link " aria-current="page" href="../formulaires/index.php">Aceuil</a>
        ...
        <li class="nav-item">
          <a class="nav-link" href="../client/connexionclient.php">Connexion</a>
        </li>
        <li class="nav-item">
          <a class="nav-link" href="../admin/connexion.php">admin</a>
        </li>
         <li class="nav-item">
          <a class="nav-link" href="../client/inscription.php">inscription</a>
        </li>
